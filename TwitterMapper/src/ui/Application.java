        ...
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (!mapMarkers.isEmpty()) {
					MapMarkerBetter marker = (MapMarkerBetter) mapMarkers.get(mapMarkers.size() - 1);
					map().setToolTipText("<html><img align=\"left\" src=" + marker.getProfilePicURL() + ">" + marker.getTweetText() + "</html>");
				}
            }
        });
    }
